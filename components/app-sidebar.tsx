...
export function AppSidebar({ selectedFolder, onFolderSelect, onManageFolders, folders }: AppSidebarProps) {
  ...
  //   ],
  // }
   // Four visual LangFlow agents (saved as flows/email.json, etc.)
 const agentWorkflows = {
   unassigned: [
     { id: "f80e0d87-2347-44bb-b3a2-2b9da0f715c0",      name: "Email Agent",      engine: "langflow" },
     { id: "pdf-agent",        name: "PDF Agent",        engine: "langflow" },
     { id: "json-agent",       name: "JSON Agent",       engine: "langflow" },
     { id: "classifier-agent", name: "Classifier Agent", engine: "langflow" },
   ],
 }
  ...
  // }
  const getWorkflowsForFolder = (folderId: string) => {
      return agentWorkflows[folderId as keyof typeof agentWorkflows] || []
  }
              ...
              {folders.map((folder) => (
                ...
                >
                  <SidebarMenuItem>
                    ...
                    <CollapsibleContent>
                      <SidebarMenuSub>
                        {getWorkflowsForFolder(folder.id).map((workflow: { id: Key | null | undefined; name: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; engine: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined }) => (
                          <SidebarMenuSubItem key={workflow.id}>
                            ...
                            >
                              ...
                              <Badge variant="outline" className={`text-xs ${getEngineColor(workflow.engine as string || "default")}`}>
                                {workflow.engine}
                              </Badge>
                            </SidebarMenuSubButton>
                          </SidebarMenuSubItem>
